...
class ReadSimPlugin:
 ...
 def output(self, outputfile):
      ...
      readcnt = int(self.parameters["readcnt"])
      bline=0;
      tbweight=0;
      for lines in open(PyPluMA.prefix()+"/"+self.parameters["posbias"]):
        bline=bline+1;
        if bline>100:
          break;
      ...
      if len(posweight)!=100:
        ...
        sys.exit();
      readlen = int(self.parameters["readlen"])
